...
import io.renren.utils.ClassPools;
...
public class SysGeneratorService {
    ...
    public PageUtils queryList(Query query) {
       ...
       // list = list.stream().filter(item -> Arrays.stream(ClassPools.str).anyMatch(i -> item.get("tableName").toString().equals(i))).collect(Collectors.toList());
